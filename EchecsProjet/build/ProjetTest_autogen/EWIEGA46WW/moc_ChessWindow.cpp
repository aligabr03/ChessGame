...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ChessWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ChessWindow_t qt_meta_stringdata_ChessWindow = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ChessWindow[] = {
...
Q_CONSTINIT const QMetaObject ChessWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ChessWindow.offsetsAndSizes,
    qt_meta_data_ChessWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ChessWindow_t,
        // Q_OBJECT / Q_GADGET

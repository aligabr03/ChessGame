...
void enleverFilmDeListeFilms(ListeFilms &liste, Film *filmAEnlever)
{
	...
	{															// On utilise cette condition car si la fonction find ne trouve pas le film à enlever dans la liste, elle retourne le dernier film de cette dernière.
		*indexFilmAEnlever = liste.elements[--liste.nElements]; // Remplace le film a enlever par la dernier film du tableau et décremente liste.nElements.
	}
}
// TODO: Une fonction pour trouver un Acteur par son nom dans une ListeFilms, qui retourne un pointeur vers l'acteur, ou nullptr si l'acteur n'est pas trouvé.  Devrait utiliser span.
Acteur *trouverActeur(ListeFilms &listeFilm, const string &nomActeur)
{
